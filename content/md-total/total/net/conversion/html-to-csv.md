---
title: Convert HTML to CSV via .NET 
weight: 5400
...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert HTML to CSV, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert HTML files to CSV in just a few lines of code.
