...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert JSON to XPS, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert JSON files to XPS in just a few lines of code.
...
// save resultant file in XPS format
workbook.Save("output.xps", Cells.SaveFormat.Auto); 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert JSON to XPS" sectionDescription="Check our live demos for [JSON to XPS conversion](https://products.aspose.app/cells/conversion/json-to-xps) with following benefits." >}}
