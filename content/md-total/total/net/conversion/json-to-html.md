---
title: Convert JSON to HTML via .NET 
weight: 5400
...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert JSON to HTML, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert JSON files to HTML in just a few lines of code.
...
// save resultant file in HTML format
workbook.Save("output.html", Cells.SaveFormat.Auto); 
