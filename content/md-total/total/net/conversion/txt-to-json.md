...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert TXT to JSON, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert TXT files to JSON in just a few lines of code.
...
var workbook = new Cells.Workbook("J8CR782.txt", new Cells.LoadOptions(Cells.LoadFormat.Auto));
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert TXT to JSON" sectionDescription="Check our live demos for [TXT to JSON conversion](https://products.aspose.app/cells/conversion/txt-to-json) with following benefits." >}}
