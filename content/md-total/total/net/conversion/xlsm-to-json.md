...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert XLSM to JSON, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert XLSM files to JSON in just a few lines of code.
...
```cs
// load XLSM file with an instance of Workbook
var workbook = new Cells.Workbook("J8CR782.xlsm", new Cells.LoadOptions(Cells.LoadFormat.Auto));
