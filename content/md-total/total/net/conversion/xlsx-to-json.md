...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert XLSX to JSON, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert XLSX files to JSON in just a few lines of code.
...
var workbook = new Cells.Workbook("J8CR782.xlsx", new Cells.LoadOptions(Cells.LoadFormat.Auto));
