---
title: Convert TSV to XLS via .NET 
weight: 5400
...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert TSV to XLS, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Total makes it easy for the developers to load & convert TSV files to XLS in just a few lines of code.
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert TSV to XLS" sectionDescription="Check our live demos for [TSV to XLS conversion](https://products.aspose.app/cells/conversion/tsv-to-xls) with following benefits." >}}
