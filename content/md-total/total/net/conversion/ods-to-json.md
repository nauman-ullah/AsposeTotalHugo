---
title: Convert ODS to JSON via .NET 
weight: 5400
...
{{% blocks/products/pf/agp/content h2="Export Excel" %}}
 ...
 In order to convert ODS to JSON, we’ll use Aspose.Total's
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert ODS to JSON via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Total makes it easy for the developers to load & convert ODS files to JSON in just a few lines of code.
...
var workbook = new Cells.Workbook("J8CR782.ods", new Cells.LoadOptions(Cells.LoadFormat.Auto));
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert ODS to JSON" sectionDescription="Check our live demos for [ODS to JSON conversion](https://products.aspose.app/cells/conversion/ods-to-json) with following benefits." >}}
    ...
    {{% blocks/products/pf/agp/content h2="How to Convert ODS to JSON Using C#" %}}
